...
var sValorCal="";
	if (isNaN(sValor)) //IsNaN= Is Not a Number (No es un numero)
...
sValorCapturado = document.getElementById("txtResultado"+i).style="border: 4px solid #FF0000; background-color: #FF0000";
	...
	if (sErr == "")
		...
		document.getElementById("aqui").innerHTML=("Calif= "+nCalif);
//		alert("Calif = "+nCalif);
	else
	    document.getElementById("aqui").innerHTML=("Errores= "+sErr);
//		alert("Errores= "+ sErr);
}
